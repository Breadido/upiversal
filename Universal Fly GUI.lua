...
do -- Example UI
	local Window = library:AddWindow("Universal Fly", {
		main_color = Color3.fromRGB(206, 0, 0),
		min_size = Vector2.new(280, 175),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = false,
	})
	local Tab = Window:AddTab("Made By Breadido")

	do -- Elements

        local Switch = Tab:AddSwitch("Toggle Fly", function(bool)
		...
		Slider:Set(50)
		local Switch = Tab:AddSwitch("Sit While Flying", function(bool)	
